...
import { XCircleIcon, MoonIcon, SunIcon } from '@heroicons/react/solid'
...
function Header({ placeholder }) {
    ...
    return (
        <header className={`fixed w-full top-0 z-50 grid sm:grid-cols-4 grid-cols-1 navbar p-5 md:px-10 ${show && "nav__stickey"}`}>
            ...
            <div className="sm:flex hidden items-center justify-end space-x-3 text-gray-400 cursor-pointer">
