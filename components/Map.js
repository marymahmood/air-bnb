...
function Map({ searchResults }) {
    ...
    return (
        <ReactMapGL
            mapStyle="mapbox://styles/maryam-mahmood/ckuxp3ejn8gg618qvbyl26i29"
            ...
            {searchResults?.map(item => (
                <div key={item.img}>
                    <Marker
                        ...
                        offsetLeft={-10}
                    >
                        <p className="cursor-pointer text-2xl relative z-40 animate-bounce" onClick={() => setSelectedLocation(item)} role="img">
